...
/* harmony default export */ var App = ({
  ...
  render() {
    ...
    return h("div", {
    ...
    }, ["MovieAI"]), h("p", ["Welcome to MovieAI, a service which gives you movie recommendations based on one that you input. Please input a movie you have watched that you enjoyed into the field below and click 'submit'."]), h("b-form", {
      "on": {
        "submit": this.getRecommendations
      }
    }, [h("b-form-group", {
      "class": "mb-1 mb-md-4",
      "attrs": {
      ...
      "class": "mb-4",
      "style": "font-size: 4rem; line-height: 0.55;"
    }, ["Results"]), h("p", ["Click on the results to search them on IMDB."]), h("b-card-text", {
      "class": "mt-4",
...
/******/ });
//# sourceMappingURL=app.4e81e655.js.map